import { IOutsideApiService, IPresentableAuthService, IPresentableService, IPresentableVersionService, ContractInfo, PresentableInfo, PresentableVersionAuthTreeInfo, UserInfo } from '../../interface';
...
export declare class PresentableAuthService implements IPresentableAuthService {
     ...
     */
    presentableNodeSideAuth(presentableInfo: PresentableInfo, presentableVersionAuthTree: PresentableVersionAuthTreeInfo[]): Promise<SubjectAuthResult>;
    /**
     * 展品上游合约授权(通过授权树获取对应的合约的授权状态即可直接判定,无需调用标的物的授权API)
     * @param presentableInfo
     * @param presentableVersionAuthTree
     */
    presentableUpstreamAuth(presentableInfo: PresentableInfo, presentableVersionAuthTree: PresentableVersionAuthTreeInfo[]): Promise<SubjectAuthResult>;
    /**
